...
import { normalizeAllowedDirectory, parseArchitectureAnalysisPaths } from "./config.js";
...
const allowedPaths = [...new Set([workingDirectory, ...architectureAnalysisPaths])];
...
If the requested absolute path is equal to or inside one of the allowed architecture analysis paths, delegate immediately to CodexArchitectureExpert using run_adk_subagent.
